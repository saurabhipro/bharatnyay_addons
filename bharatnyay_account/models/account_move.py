...
from odoo.addons.bharatnyay_core.models.product_template import BHARAT_ARBITRATION_STAGE_SELECTION
...
class AccountMove(models.Model):
    ...
    def action_print_arbitration_annexure(self):
        ...
        report = self.env.ref(
            'bharatnyay_account.action_report_bharat_arbitration_invoice_annexure',
    ...
    def dashboard_invoiced_charges_pipeline(self, loan_ids=None):
        ...
        from odoo.addons.bharatnyay_core.models.loan_milestone import POSTAL_BILLING_MILESTONE_NUMBERS
